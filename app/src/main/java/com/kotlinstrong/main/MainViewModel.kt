...
class MainViewModel : BaseViewModel() {
    ...
    fun getArticleList(page: Int) {
        launch {
            ...
            executeResponse(result, { mArticleList.postValue(result.data) }, { LogUtils.e(tag,result.message) })
        }
    }
    ...
    fun login() {
        launch {
            ...
            executeResponse(result, { loginLiveData.postValue(result.data) }, { LogUtils.e(tag,result.message) })
        }
    }
}